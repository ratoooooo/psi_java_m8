...
public class Atividade5 {
	...
	private void initialize() {
		...
		rdbtnMonitorCrt.addMouseListener(new MouseAdapter() {
			@Override
		...
		rdbtnMonitorLcd.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				recaucularValor();
			}
		...
		rdbtnWebCam.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				recaucularValor();
			}
		...
		rdbtnImpressora.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				recaucularValor();
			}
		...
		rdbtnScanner.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				recaucularValor();
			}
